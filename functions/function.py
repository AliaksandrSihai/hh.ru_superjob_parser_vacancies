...
def start_with_user():
    ...
    if chose_platforms == "1":
        ...
        return vacancies_from_hh, superjob_api
...
def comparison_by_salary():
    ...
    vacancies_from.vacancy_salary = salary[0].split('-')[0] if salary and salary[0].split('-')[0].isdigit() else 0
    vacancies_from.other_salary = salary[1].split('-')[0] if salary and salary[1].split('-')[0].isdigit() else 0
